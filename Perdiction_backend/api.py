...
def player_stats():
    try:
        ...
        # Check if player is in top 30 and return hardcoded values with random variation
        ...
        # Load your dataset if the player is not in top 30
...
#         # Convert to numpy array
#         x = x.values  # Corrected to use .values without parentheses
        
#         # Predict the player stats using the loaded model
#         prediction = loaded_model.predict(x)  # Use the numpy array for prediction
